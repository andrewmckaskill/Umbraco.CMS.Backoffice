import { UmbRecurringBackgroundJobsRepository } from '../repository/recurring-background-jobs.repository.js';
import { UmbRecurringBackgroundJobsStore } from './recurring-background-jobs.store.js';
import { UmbRecurringBackgroundJobItemStore } from './recurring-background-job-item.store.js';
...
const repository: ManifestRepository = {
	...
	class: UmbRecurringBackgroundJobsRepository,
};
